...
if [ "$IS_COORDINATOR" == "true" ]; then
  if [ "$IS_ZIGBEE3" == "true" ]; then
    ...
    ./cc_erase $FLAGS
    ./cc_write $FLAGS CC2531ZNP-with-SBL.hex
  else
    ...
    ./cc_erase $FLAGS
    ./cc_write $FLAGS CC2531ZNP-Prod.hex
  fi
else
  ...
  case $ROUTER_LEVEL in
    0)
      ...
      ./cc_erase $FLAGS
      ./cc_write $FLAGS router-cc2531-std.hex
      ;;
    1)
      ...
      ./cc_erase $FLAGS
      ./cc_write $FLAGS router-cc2531-diag.hex
      ;;
    2)
      ...
      ./cc_erase $FLAGS
      ./cc_write $FLAGS router-cc2531-diag-usb.hex
      ;;
    *)
